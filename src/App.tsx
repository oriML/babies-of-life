...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const handleIntersect = () => {
      const isHeroVisible = heroRef.current ? 
        (heroRef.current.getBoundingClientRect().top < window.innerHeight && heroRef.current.getBoundingClientRect().bottom > 0) : false;
      const isFooterVisible = footerRef.current ? 
        (footerRef.current.getBoundingClientRect().top < window.innerHeight && footerRef.current.getBoundingClientRect().bottom > 0) : false;
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 selection:bg-soft-pink-200 overflow-x-hidden text-center md:text-right" dir="rtl" style={{ fontFamily: '"Varela Round", sans-serif' }}>
      ...
      {/* 2. Hero Section */}
      <section ref={heroRef} className="relative h-screen flex flex-col items-center justify-center text-center px-4 bg-gradient-to-b from-soft-pink-100/40 to-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-20">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 text-center md:text-right">
              <div className="inline-block px-6 py-2 bg-soft-pink-100 text-soft-pink-700 rounded-full font-bold text-sm mx-auto md:mx-0">סיפורם של המתנדבים בעמותת עולל</div>
              <h2 className="text-5xl font-bold leading-tight text-gray-900 text-center md:text-right">למה אנחנו פועלים בתינוקות של החיים</h2>
              <p className="text-2xl text-gray-600 leading-relaxed font-light text-center md:text-right">
                כשאנחנו מגיעים למשפחות אנחנו רואים עד כמה הציוד הזה קריטי. אנחנו שם כדי להעניק להן את השקט הנפשי שהתינוק שלהן יקבל את כל מה שהוא צריך.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-soft-pink-50/30 p-8 rounded-[3rem] shadow-sm border border-soft-pink-100 text-center space-y-4">
                <span className="text-5xl font-bold text-soft-pink-500 block text-center">20</span>
                <p className="text-lg font-bold text-gray-800 leading-tight text-center">פניות חדשות בכל יום</p>
              </div>
              <div className="bg-soft-pink-50/30 p-8 rounded-[3rem] shadow-sm border border-soft-pink-100 text-center space-y-4">
                <span className="text-5xl font-bold text-soft-pink-500 block text-center">50%</span>
                <p className="text-lg font-bold text-gray-800 leading-tight text-center">עלייה בביקוש לתמ"ל רפואי</p>
              </div>
              <div className="bg-white p-8 rounded-[3rem] shadow-md border border-soft-pink-100 text-center space-y-4 col-span-2">
                <p className="text-xl text-gray-600 font-medium text-center">אנחנו שומעים את קולן של מאות אימהות בכל חודש</p>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-40 bg-[#fff5f7] px-4 overflow-hidden">
        <div className="max-w-4xl mx-auto space-y-16 text-center relative z-20">
          <div className="text-center space-y-4">
            <h2 className="text-5xl font-bold text-gray-900 text-center">סיפורים מהמלחמה</h2>
            <p className="text-xl text-soft-pink-600 font-medium text-center">מאז ה 7.10 הלב שלנו פוגש גבורה ושברון לב בכל יום</p>
          ...
          <article className="group flex flex-col md:flex-row gap-8 items-start bg-white p-10 rounded-[3.5rem] shadow-sm border border-soft-pink-50 text-center md:text-right hover:shadow-lg transition-all">
            <div className="bg-soft-pink-100 p-6 rounded-[2rem] text-soft-pink-600 group-hover:bg-soft-pink-500 group-hover:text-white transition-all shrink-0 mx-auto md:mx-0"><BookOpen className="w-10 h-10" /></div>
            <div className="space-y-4 text-center md:text-right">
              <h3 className="text-3xl font-bold text-gray-900 leading-tight">השקט של שוהם הקטנה</h3>
              <p className="text-xl text-gray-600 leading-relaxed font-light">
                פגשנו את נעמי באשדוד אמא לשישה שסוחבת על גבה עול בלתי יאומן. היא בהריון מתקדם והמלחמה השאירה אותם ללא פרנסה. כשמסרנו לה את התמ"ל והטיטולים עבור שוהם התינוקת ראינו איך האבן נגולה מעל ליבה.
              </p>
            </div>
          </article>
          ...
          <article className="group flex flex-col md:flex-row gap-8 items-start bg-white p-10 rounded-[3.5rem] shadow-sm border border-soft-pink-50 text-center md:text-right hover:shadow-lg transition-all">
            ...
            <div className="space-y-4 text-center md:text-right">
              ...
              <p className="text-xl text-gray-600 leading-relaxed font-light">
                גליה עברה לאשדוד באמצע המלחמה פצועה אחרי ניתוח. עזרנו להם עם מטרנות וטיטולים בדיוק ברגעים שהכל נראה אבוד. היום גליה הודתה לנו עם דמעות של נחת בעיניים.
              </p>
            </div>
          </article>
      ...
      <section className="relative py-32 bg-white px-4">
        <div className="max-w-6xl mx-auto space-y-16 relative z-20 text-center md:text-right">
          <div className="text-center space-y-4">
            <h2 className="text-4xl font-bold text-gray-900 text-center">עוד רגעים שאנחנו לא שוכחים</h2>
            <p className="text-lg text-gray-500 text-center">כל פניה היא עולם ומלואו של תקווה ושובע</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "הבית של מזל ודוד", text: "מזל ודוד איבדו הכל בשריפה. בתוך השכול מזל פנתה אלינו כדי שלפחות לתינוק יהיה את השובע שלו. אנחנו כאן כדי לתת לה אותו בכבוד." },
              { title: "ההודעה של אבישג", text: "בשתיים בלילה קיבלנו הודעה מאבישג. בתוך גירושין קשים היא רק רצתה לדעת שיהיה לה מטרנה למחר. המתנדבים שלנו נרתמו מיד." },
              { title: "המאבק של מוטי", text: "מוטי מגדל לבדו תינוק בן חודשיים. התפקיד שלנו הוא להסיר ממנו את הדאגה לאוכל וציוד כדי שיוכל להתמקד רק בטיפול ובאהבה." },
              ...
              <div key={i} className="bg-soft-pink-50/30 p-8 rounded-[3rem] border border-soft-pink-100 flex flex-col h-full hover:shadow-md transition-shadow text-center md:text-right">
                <h3 className="text-2xl font-bold mb-4 text-soft-pink-600 text-center md:text-right">{story.title}</h3>
                <p className="text-gray-600 leading-relaxed font-light text-center md:text-right">{story.text}</p>
              </div>
            ))}
          </div>
      ...
      <section className="relative py-32 bg-[#fff5f7] px-4 overflow-hidden">
        <div className="max-w-6xl mx-auto space-y-16 relative z-20 text-center md:text-right">
          <div className="text-center space-y-4">
            <h2 className="text-5xl font-bold text-gray-900 text-center">סלבס נרתמים למען התינוקות</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group relative aspect-[3/4] rounded-[3rem] overflow-hidden shadow-xl border-4 border-white transition-all hover:scale-[1.02]">
              <img src="/selebs-photos/תמונה מסטטוס בוואטסאפסלבס מגיעים להתנדב - דון לני גבאי ויאנה יוסף.jpeg" alt="דון לני גבאי ויאנה יוסף מתנדבות" className="w-full h-full object-cover" />
            ...
            <div className="group relative aspect-[3/4] rounded-[3rem] overflow-hidden shadow-xl border-4 border-white transition-all hover:scale-[1.02]">
              <img src="/selebs-photos/תמונה מסטטוס בוואטסאפסלבס מגיעים להתנדב ג'קי אזולאי ואודליה סויסה.jpeg" alt="ג'קי אזולאי ואודליה סויסה מתנדבות" className="w-full h-full object-cover" />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8 text-white text-center md:text-right">
            ...
            <div className="group relative aspect-[3/4] rounded-[3rem] overflow-hidden shadow-xl border-4 border-white transition-all hover:scale-[1.02]">
              <img src="/selebs-photos/סלבס מגיעים להתנדב תמונה מעיתון.jpeg" alt="סלבס מתנדבים מהעיתונות" className="w-full h-full object-cover" />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8 text-white text-center md:text-right">
          ...
          <div className="pt-12 flex justify-center text-center">
            <button onClick={scrollToDonation} className="bg-soft-pink-500 text-white px-12 py-5 rounded-2xl font-bold text-xl hover:bg-soft-pink-600 transition-all shadow-xl">אני רוצה להירתם</button>
          </div>
        </div>
        <WaveDivider color="#ffffff" position="bottom" />
      </section>
      ...
      <section className="relative py-40 bg-white px-4 overflow-hidden">
        <div className="max-w-6xl mx-auto space-y-24 relative z-20 text-center">
          <div className="space-y-12 text-center">
            <h2 className="text-4xl font-bold text-gray-900 text-center">הפעילות שלנו בשטח</h2>
          ...
          <div className="space-y-12 text-center">
            <h2 className="text-4xl font-bold text-gray-900 text-center">קולות של אמהות רגועות</h2>
      ...
      <section className="relative py-48 bg-[#f96894] text-white px-4 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-12 relative z-20">
          ...
          <h2 className="text-5xl md:text-6xl font-bold leading-tight text-center">איך אנחנו יכולים לבחור מי ילך לישון שבע?</h2>
          <p className="text-2xl md:text-3xl font-light leading-relaxed opacity-95 text-center">
            השאיפה שלנו היא שלא אצטרך לבחור לעולם. אנחנו רוצים שלכל תינוק יהיה את השובע שלו ולכל אמא יהיה את השקט שלה. בעזרתכם אנחנו יכולים להבטיח שלמתוק של עוד אמא לא יחסר דבר הלילה.
          </p>
      ...
      <section ref={donationRef} className="relative py-40 bg-white px-4 overflow-hidden text-center">
        <div className="max-w-6xl mx-auto relative z-20 text-center">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-5xl font-bold text-gray-900 text-center">עזרו לנו להעניק להם שובע</h2>
            <p className="text-2xl text-gray-500 text-center">בחרו איך אתם רוצים לעזור לעוד תינוק ללכת לישון שבע</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div key={i} className={`bg-white border-2 ${pkg.popular ? 'border-soft-pink-500 shadow-2xl scale-105 z-10' : 'border-soft-pink-100'} rounded-[3.5rem] p-10 flex flex-col items-center text-center hover:shadow-2xl transition-all hover:-translate-y-2 group relative`}>
                ...
                <h3 className="text-3xl font-bold mb-4 text-center">{pkg.title}</h3>
                <p className="text-gray-500 mb-8 text-lg leading-relaxed text-center">{pkg.text}</p>
                <div className="text-4xl font-bold text-soft-pink-600 mb-10 text-center">₪{pkg.price}</div>
          ...
          <div className="bg-soft-pink-50 p-12 rounded-[4rem] text-center max-w-2xl mx-auto border border-soft-pink-100 shadow-sm mb-12">
            <h4 className="text-2xl font-bold mb-6 text-center">רוצים לעזור לנו בסכום אחר?</h4>
            <p className="text-gray-600 mb-10 text-lg text-center">כל עזרה שלכם מאפשרת לנו להעניק לעוד תינוק את השובע שלו</p>
            <button onClick={() => handleExternalDonate()} className="bg-white border-2 border-soft-pink-500 text-soft-pink-600 px-12 py-4 rounded-2xl font-bold text-xl hover:bg-soft-pink-500 hover:text-white transition-all shadow-md mx-auto">אני רוצה לתרום סכום אחר</button>
          </div>
        </div>
      ...
      {/* 7. Footer */}
      <footer ref={footerRef} className="relative bg-[#c7245a] text-white px-4 pt-16 pb-12 overflow-hidden text-center">
        <div className="max-w-6xl mx-auto flex flex-col items-center text-center relative z-20">
          <div className="bg-white p-4 rounded-3xl mb-8 shadow-xl text-center"><Heart className="w-10 h-10 text-soft-pink-600 fill-soft-pink-100 mx-auto" /></div>
          <div className="grid md:grid-cols-2 gap-12 w-full mb-12 items-center text-center">
            <div className="space-y-4 text-center">
              <h4 className="text-3xl font-bold text-center">תינוקות של החיים</h4>
              <p className="text-xl opacity-90 leading-relaxed max-w-md mx-auto text-center">אנחנו כאן כדי לוודא שכל תינוק ילך לישון שבע ושכל אמא תהיה רגועה. ביחד אנחנו נותנים להם התחלה רכה.</p>
              <div className="pt-4 border-t border-white/20 mt-4">
                <p className="text-sm font-medium opacity-80 text-center italic">דף זה הוקם ומנוהל על ידי מתנדב שותף בעמותה המקדיש את זמנו למען התינוקות.</p>
              </div>
            </div>
            <div className="space-y-6 text-center">
              <h4 className="text-xl font-bold text-center">הצטרפו אלינו למשימה</h4>
              <button onClick={scrollToDonation} className="bg-white text-soft-pink-600 px-10 py-4 rounded-2xl font-bold text-lg hover:bg-soft-pink-50 transition-all shadow-lg mx-auto">אני רוצה לעזור</button>
              <p className="text-sm opacity-60 text-center">הפעילות מתבצעת בשיתוף עמותת עולל עזרה ואהבה ע"ר | סעיף 46 מוכר לצרכי מס</p>
            </div>
          </div>
          <div className="w-full h-px bg-white/10 mb-8 text-center"></div>
          <p className="text-xs opacity-50 text-center">© 2026 כל הזכויות שמורות למען התינוקות</p>
        </div>
      </footer>
    </div>
  );
